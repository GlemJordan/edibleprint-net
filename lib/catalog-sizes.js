...
export const CATALOG_SIZES = {
  ...
  multicircle: [
    // No 1.25" ("40 mini cookies/sheet") entry — retired. Nobody ever
    // ordered it, it's the most expensive size to plotter-cut, and image
    // quality at that size isn't reliably good. See lib/cutting-config.js
    // for the two remaining sizes' plotter-cut surcharges.

...
export const MATERIALS = {
  ...
  wafer: {
    label: 'Wafer Paper',
    recommended: false,
    description: "Thinner and more brittle than icing sheets, absorbs moisture more easily, and prints slightly less vivid colour — but it's more economical and needs no transfer step.",
  },
};
